...
if [ -z "$GITHUB_TOKEN" ]; then
  ...
  githubUrl=https://2382546457:${GITHUB_TOKEN}@github.com/2382546457/2382546457.github.io.git
  git config --global user.name "2382546457"
  git config --global user.email "2382546457@qq.com"
fi
git init
git add -A
git commit -m "${msg}"
